...
A **software library** does not have output, unless used in something else. Like a organ inside an organism, which has functions or libraries of functions. But human beings are not organs - organs cannot express any independence.
